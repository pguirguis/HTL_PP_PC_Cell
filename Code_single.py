...
PP_Cell_power= np.zeros(k_n2)
PP_Cell_power_sd = np.zeros(k_n2)
PC_Cell_power= np.zeros(k_n2)
PC_Cell_power_sd = np.zeros(k_n2)
PC_PP_power= np.zeros(k_n2)
...
PP_PC_power = [PC_PP_power_sd[2],PC_PP_power_sd[1],PC_PP_power_sd[4],PC_PP_power_sd[3]]

PP_PC_kf= np.zeros(k_n3)
PP_PC_sd = np.zeros(k_n3)
PC_Cell_kf= np.zeros(k_n3)
PC_Cell_sd = np.zeros(k_n3)
PP_Cell_kf= np.zeros(k_n3)
